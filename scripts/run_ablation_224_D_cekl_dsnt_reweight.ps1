...
& .\.venv\Scripts\python -u train_probe_heatmap.py `
  ...
  --heatmap_hard_kpts 3,4,5,6,10 --heatmap_hard_kpt_weight $HardWeight --heatmap_other_kpt_weight 1.0 `
  ...
  --logdir log/ablation_224_D_cekl_dsnt_reweight
